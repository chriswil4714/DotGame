...
public class dotComArray extends JFrame {
	...
	import java.net.*;
		...
		public static JButton ok = new JButton("OK");//closes stats menu
							   done =new JButton("Done");//closes options menu
		public static JFrame statistics= new JFrame("Statistics"),//holds stats
							  options=new JFrame("Options");//holds opts
		public static JLabel data,//used for stats menu
							  title;//used for options menu
		public static JPanel stats = new JPanel(),//used for stats menu
							  opts,//used for options menu
							  inputpanel;//for manually inputting ships
		public static Container b,c,d;//board and input panel 
		public JPanel input;//input bar	
		public static JMenuItem m,pvp,pvc,cvc;//menu items	
		public static String[] cletters = {"A","B","C","D","E","F","G"},
		//array of letters used for combo boxes
				    	 cnumbers = {"1","2","3","4","5","6","7"},
		...
		public JComboBox cshi = new JComboBox(ships),//ships
						  cdir = new JComboBox(direction);//directions
		public static JComboBox aiLevel=new JComboBox(level),
							     shipLayout=new JComboBox(layout),
								 shipColor=new JComboBox(colors),
								 playsFirst=new JComboBox(first);//used
						  			//for options menu
		public JTextField mbar = new JTextField();//message bar	
		...
		public static JButton deploy=new JButton("DEPLOY");
		public static int w=0,a=0,s=0,t=0,e=0;//counters to track the use of all ships
		public static String[][] shiphit=new String[10][10];
		public static String user,user2;
		public static Color[] color={Color.cyan,Color.green,Color.yellow,Color.magenta,
										Color.pink,	Color.red,	Color.white};		 	
		public static Object selectedValue=" ",
							  gametype;
		public static BattleshipClient me;
		...
		public class ShipsListener implements ActionListener
		{	
		...
		public class DirectListener implements ActionListener
		{	
			public void actionPerformed(ActionEvent v)
			{						
		...
		{	
			...
			public class SColorListener implements ActionListener
			{	
				public void actionPerformed(ActionEvent v)
				{	
					for (i=0;i<10;i++)
